...
import { ArrowLeft, MessageCircle, Play, Square, Mic, MicOff } from 'lucide-react';
...
export default function SpeakingPage() {
  ...
  const loadDefaultQuestion = async () => {
    try {
      const question = await speakingService.generateSpeakingQuestion('beginner', 'personal');
      ...
      setCurrentQuestion({
        ...
        hints: ["Take your time", "Say it slowly: 'My name is...'", "It's okay to practice a few times"]
      });
    }
  };
  ...
  const loadEncouragement = async () => {
    try {
      const encouragementData = await speakingService.getEncouragement('just started');
